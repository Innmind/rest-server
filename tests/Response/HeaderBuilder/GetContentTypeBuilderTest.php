...
class GetContentTypeBuilderTest extends \PHPUnit_Framework_TestCase
{
    private $builder;

    public function setUp()
    {
        $this->builder = new GetContentTypeBuilder(
            new Formats(
    ...
    {
        $this->assertInstanceOf(GetBuilderInterface::class, $this->builder);
    }
